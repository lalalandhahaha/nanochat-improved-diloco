...
class MuonAdamW(torch.optim.Optimizer):
    ...
    """
    def __init__(self, param_groups: list[dict],use_dist: bool = True):
    ...
    def step(self):
        ...
        # use_dist=False also forces the local path: used by DiLoCo, where each worker
        # optimizes on its own data locally and syncing is handled by the outer optimizer.
